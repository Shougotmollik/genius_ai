...
class BarProductRequestScreen extends StatefulWidget {
  const BarProductRequestScreen({super.key});

  @override
  State<BarProductRequestScreen> createState() =>
      _BarProductRequestScreenState();
}

class _BarProductRequestScreenState extends State<BarProductRequestScreen> {
  int selectedIndex = 0;
