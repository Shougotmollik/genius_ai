...
class MenuMyRequestScreen extends StatefulWidget {
  const MenuMyRequestScreen({super.key});

  @override
  State<MenuMyRequestScreen> createState() => _MenuMyRequestScreenState();
}

class _MenuMyRequestScreenState extends State<MenuMyRequestScreen> {
  int selectedIndex = 0;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Data Rows
          _buildDataRow('Item Count', item.itemCount),
          SizedBox(height: 8),
          _buildDataRow('Cost', item.cost),
          SizedBox(height: 8),
          _buildDataRow('Type', item.type),
        ],
      ),
    );
  }
