...
class RestaurantAccountSettingScreen extends StatefulWidget {
  const RestaurantAccountSettingScreen({super.key});

  @override
  State<RestaurantAccountSettingScreen> createState() =>
      _RestaurantAccountSettingScreenState();
}

class _RestaurantAccountSettingScreenState
    extends State<RestaurantAccountSettingScreen>
  ...
  void _savePassword() async {
    ...
    final bool updated = await _userController.updatePassword(
