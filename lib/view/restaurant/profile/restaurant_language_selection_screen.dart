...
class RestaurantLanguageSelectionScreen extends StatefulWidget {
  const RestaurantLanguageSelectionScreen({super.key});

  @override
  State<RestaurantLanguageSelectionScreen> createState() =>
      _RestaurantLanguageSelectionScreenState();
}

class _RestaurantLanguageSelectionScreenState
    extends State<RestaurantLanguageSelectionScreen> {
  //  selected language
