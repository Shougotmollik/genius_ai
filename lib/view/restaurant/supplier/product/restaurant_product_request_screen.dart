...
import 'package:genius_ai/model/supplier_product.dart';
import 'package:genius_ai/view/widgets/info_highlighter_card.dart';

class RestaurantProductRequestScreen extends StatefulWidget {
  const RestaurantProductRequestScreen({super.key});

  @override
  State<RestaurantProductRequestScreen> createState() =>
      _RestaurantProductRequestScreenState();
}

class _RestaurantProductRequestScreenState
    extends State<RestaurantProductRequestScreen> {
  int selectedIndex = 0;

  // Data List
  final List<SupplierProduct> allItems = [
    SupplierProduct(
      title: "Sugar Syrup",
  ...
  List<SupplierProduct> get filteredItems {
    if (selectedIndex == 1) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildDataRow('Quality', item.quality),
          const SizedBox(height: 8),
          _buildDataRow('Purchase Date', item.purchaseDate),
        ],
      ),
    );
  }
