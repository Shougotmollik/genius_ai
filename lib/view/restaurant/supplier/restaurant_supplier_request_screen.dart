...
class RestaurantSupplierRequestScreen extends StatefulWidget {
  const RestaurantSupplierRequestScreen({super.key});

  @override
  State<RestaurantSupplierRequestScreen> createState() =>
      _RestaurantSupplierRequestScreenState();
}

class _RestaurantSupplierRequestScreenState
    extends State<RestaurantSupplierRequestScreen> {
  int selectedIndex = 0;
