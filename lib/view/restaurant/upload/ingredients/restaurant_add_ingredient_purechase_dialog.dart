...
class RestaurantAddIngredientPurchaseDialog extends StatefulWidget {
  const RestaurantAddIngredientPurchaseDialog({super.key});

  @override
  State<RestaurantAddIngredientPurchaseDialog> createState() =>
      _RestaurantAddIngredientPurchaseDialogState();
}

class _RestaurantAddIngredientPurchaseDialogState
    extends State<RestaurantAddIngredientPurchaseDialog> {
