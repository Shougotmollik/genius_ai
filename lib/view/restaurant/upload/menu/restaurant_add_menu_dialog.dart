...
class RestaurantAddMenuDialog extends StatefulWidget {
  const RestaurantAddMenuDialog({super.key});

  @override
  State<RestaurantAddMenuDialog> createState() => _RestaurantAddMenuDialogState();
}

class _RestaurantAddMenuDialogState extends State<RestaurantAddMenuDialog> {
  // --- Controllers & State ---
